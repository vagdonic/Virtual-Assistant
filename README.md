...
The assistant talks to the wolframalpha API(which requires a signup from <a href="http://wolframalpha.com/"> and generating an "APP ID" to use in the code. It also talks directly with the wikipedia API to find a more descriptive answers for the required questions along with a beautiful and minimal UI. All of this to get all your answer in one place.
